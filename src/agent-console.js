import { campaignPanel, campaignContext } from "./campaign.js";
...
export function createAgentConsole({
  ...
  function openAgent(id) {
    ...
    document.querySelector("#run-agent")?.addEventListener("click", () => {
      runAgents(manager(), state.running, [id], state.campaign);
      closeModal();
      refresh();
      openAgent(id);
    });
